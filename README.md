...
`41 public repos` · `43 stars` · `shipping since Feb 2026` · `synced 2026-09-15 08:20 UTC`
...
| [`CP`](https://github.com/ka1rav6/CP) | C | A mix of my solutions of Codeforces CP31 questions in different languages. | 14d ago | `warm` |
| [`zero-dependency`](https://github.com/ka1rav6/zero-dependency) | C++ | Our submission for the zero dependency's hackathon | 15d ago | `warm` |
