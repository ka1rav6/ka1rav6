...
`40 public repos` · `42 stars` · `shipping since Feb 2026` · `synced 2026-09-08 07:47 UTC`

**most recently touched**

| repo | lang | what | last push | state |
|---|---|---|---|---|
| [`mlux`](https://github.com/ka1rav6/mlux) | — | A fully customizable terminal multiplexer with the ability to save sessions and rest | today | `building` |
| [`CP`](https://github.com/ka1rav6/CP) | C | A mix of my solutions of Codeforces CP31 questions in different languages. | 7d ago | `warm` |
| [`zero-dependency`](https://github.com/ka1rav6/zero-dependency) | C++ | Our submission for the zero dependency's hackathon | 8d ago | `warm` |
| [`ka1rav6.github.io`](https://github.com/ka1rav6/ka1rav6.github.io) | TypeScript | Making a website that contains my portfolio | 9d ago | `warm` |
| [`pico`](https://github.com/ka1rav6/pico) | C++ | A whole build system for c++ projects. | 28d ago | `resting` |
| [`hand-gesture-recognition`](https://github.com/ka1rav6/hand-gesture-recognition) | Python | Creating a Hand Gesture recognition AI model for a game | 29d ago | `resting` |
