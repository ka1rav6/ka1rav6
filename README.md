...
`41 public repos` · `43 stars` · `shipping since Feb 2026` · `synced 2026-09-18 07:56 UTC`
...
| [`CP`](https://github.com/ka1rav6/CP) | C | A mix of my solutions of Codeforces CP31 questions in different languages. | 17d ago | `warm` |
| [`zero-dependency`](https://github.com/ka1rav6/zero-dependency) | C++ | Our submission for the zero dependency's hackathon | 18d ago | `warm` |
