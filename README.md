...
`41 public repos` · `43 stars` · `shipping since Feb 2026` · `synced 2026-09-22 08:12 UTC`
...
| [`mlux`](https://github.com/ka1rav6/mlux) | Makefile | A fully customizable terminal multiplexer with the ability to save sessions and rest | 4d ago | `warm` |
| [`ka1rav6.github.io`](https://github.com/ka1rav6/ka1rav6.github.io) | TypeScript | Making a website that contains my portfolio | 11d ago | `warm` |
| [`CP`](https://github.com/ka1rav6/CP) | C | A mix of my solutions of Codeforces CP31 questions in different languages. | 21d ago | `warm` |
| [`zero-dependency`](https://github.com/ka1rav6/zero-dependency) | C++ | Our submission for the zero dependency's hackathon | 22d ago | `resting` |
