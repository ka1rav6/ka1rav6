...
`39 public repos` · `42 stars` · `shipping since Feb 2026` · `synced 2026-09-05 07:21 UTC`

**most recently touched**

| repo | lang | what | last push | state |
|---|---|---|---|---|
| [`CP`](https://github.com/ka1rav6/CP) | C | A mix of my solutions of Codeforces CP31 questions in different languages. | 4d ago | `warm` |
| [`zero-dependency`](https://github.com/ka1rav6/zero-dependency) | C++ | Our submission for the zero dependency's hackathon | 5d ago | `warm` |
...
| [`pico`](https://github.com/ka1rav6/pico) | C++ | A whole build system for c++ projects. | 25d ago | `resting` |
| [`hand-gesture-recognition`](https://github.com/ka1rav6/hand-gesture-recognition) | Python | Creating a Hand Gesture recognition AI model for a game | 26d ago | `resting` |
